        ...
        if (dataSnapshot.getValue() != null) {
            ...
            try {
                ...
                listView.setOnItemClickListener((parent, view, position, id) -> {
                    ...
                    fm.beginTransaction().replace(R.id.catalog_container, new CatalogItemFragment(commonName, minHeight, maxHeight, minDist, imageUrl)).setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE).addToBackStack(null).commit();
                });
            } catch (Exception e) {
